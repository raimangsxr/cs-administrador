...
angular.module('csAdministratorApp')
  .controller('ListDetailAuditReviewCtrl', ['$rootScope', '$scope', '$log', '$http', '$cookies', '$uibModal', '$uibModalInstance', 'file', function ($rootScope, $scope, $log, $http, $cookies, $uibModal, $uibModalInstance, file) {
