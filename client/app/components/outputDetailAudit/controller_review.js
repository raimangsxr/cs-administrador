...
angular.module('csAdministratorApp')
  .controller('OutputDetailAuditModalReviewCtrl', ['$rootScope', '$scope', '$log', '$http', '$cookies', '$uibModal', '$uibModalInstance', 'file', function ($rootScope, $scope, $log, $http, $cookies, $uibModal, $uibModalInstance, file) {
